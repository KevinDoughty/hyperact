...
function(module, __webpack_exports__, __webpack_require__) {
                    ...
                    Object.defineProperty(HyperStyleDeclaration.prototype, property, {
                        ...
                        set: function set(value) {
                            ...
                            if (animatables[property]) {
                                this.hyperStyleController.registerAnimatableProperty(property, animatables[property]);
                            }
    ...
    function activateElement(element, controller, delegate) {
        ...
        hyperStyleDelegate.typeOfProperty = function(property) {
            if (delegate && isFunction$4(delegate.typeOfProperty)) return delegate.typeOfProperty.call(delegate, property);
            // Not very useful.
        ...
        var previousLayer = {};
        activate(controller, hyperStyleDelegate, layer);
