...
function(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "a", function() {
        return registerAnimatableStyles;
    });
    /* harmony export (binding) */
    ...
    /* unused harmony export HyperNumber */
    /* unused harmony export HyperScale */
    /* unused harmony export HyperArray */
    ...
    function HyperAction() {
        ...
        this.fillMode;
        // string. Defaults to "none". NOT FINISHED. "forwards" and "backwards" are "both". maybe should be named "fill". maybe should just be a boolean. // I'm unsure of the effect of combining a forward fill with additive // TODO: implement removedOnCompletion
        this.index = 0;
    ...
    function animationFromDescription(description) {
        ...
        if (!description && (TRANSACTION_DURATION_ALONE_IS_ENOUGH$1 || description !== 0)) return description;
    ...
    function implicitAnimation(property, prettyValue, prettyPrevious, prettyPresentation, delegate, defaultAnimation, transaction) {
        ...
        if (!animation) {
            animation = animationFromDescription(defaultAnimation);
    ...
    function activate(controller, delegate, layerInstance) {
        ...
        // This is not nulled out anymore
    ...
    HyperStyle.activate = function(element, receiver) {
        ...
        hyperStyleDelegate.typeOfProperty = function(property, value) {
            if (delegate && isFunction$4(delegate.typeOfProperty)) return delegate.typeOfProperty.call(delegate, property, value);
            // Not very useful.
        ...
        hyperStyleDelegate.input = function(property, prettyValue) {
            ...
            if (delegate && isFunction$4(delegate.input)) return delegate.input.call(delegate, property, prettyValue);
            ...
            for (var i = 0; i < value.length; i++) {
                switch (value[i].t) {
                  ...
                  case "skewY":
                    out.push({
                        t: value[i].t,
                        d: [ numberType.inverse(value[i].d[0]) ]
                    });
                  ...
                  case "skew":
                    out.push({
                        t: value[i].t,
                        d: [ numberType.inverse(value[i].d[0]), numberType.inverse(value[i].d[1]) ]
                    });
                    break;
                  ...
                  case "translate":
                    out.push({
                        t: value[i].t,
                        d: [ {
                            px: numberType.inverse(value[i].d[0].px)
                        }, {
                            px: numberType.inverse(value[i].d[1].px)
                        } ]
                    });
                    break;
                  ...
                  case "translate3d":
                    out.push({
                        ...
                        d: [ {
                            ...
                            px: numberType.inverse(value[i].d[2].px)
                        } ]
                    });
                    break;
                  ...
                  case "matrix":
                    out.push({
                        t: value[i].t,
                        d: [ numberType.inverse(value[i].d[0]), numberType.inverse(value[i].d[1]), numberType.inverse(value[i].d[2]), numberType.inverse(value[i].d[3]), numberType.inverse(value[i].d[4]), numberType.inverse(value[i].d[5]) ]
                    });
                    break;
                }
            }
                ...
                if (i < diff) {
                    ...
                    switch (value[i].t) {
                      ...
                      case "skewY":
                        out.push({
                            t: value[i].t,
                            d: [ numberType.add(value[i].d[0], delta[j].d[0]) ]
                        });
                        // new style, have to unwrap then re-wrap
                        break;
                      ...
                      case "skew":
                        out.push({
                            t: value[i].t,
                            d: [ numberType.add(value[i].d[0], delta[j].d[0]), numberType.add(value[i].d[1], delta[j].d[1]) ]
                        });
                        break;
                      ...
                      case "translate":
                        out.push({
                            t: value[i].t,
                            d: [ {
                                px: numberType.add(value[i].d[0].px, delta[j].d[0].px)
                            }, {
                                px: numberType.add(value[i].d[1].px, delta[j].d[1].px)
                            } ]
                        });
                        break;
                      ...
                      case "translate3d":
                        out.push({
                            ...
                            d: [ {
                                ...
                                px: numberType.add(value[i].d[2].px, delta[j].d[2].px)
                            } ]
                        });
                        break;
                      ...
                      case "matrix":
                        out.push({
                            t: value[i].t,
                            d: [ numberType.add(value[i].d[0], delta[j].d[0]), numberType.add(value[i].d[1], delta[j].d[1]), numberType.add(value[i].d[2], delta[j].d[2]), numberType.add(value[i].d[3], delta[j].d[3]), numberType.add(value[i].d[4], delta[j].d[4]), numberType.add(value[i].d[5], delta[j].d[5]) ]
                        });
                        break;
...
function(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var __WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__ = __webpack_require__(0);
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["a"])({
        // an inconvenience that will eventually allow tree shaking unused css animation types
        transform: __WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["b"]
    });
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["c"])(zero);
    var One = function() {
        function One(name) {
            ...
            this.x = 0;
            this.y = 0;
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["c"])(this);
        }
        _createClass(One, [ {
            key: "display",
    ...
    var Three = function() {
        function Three(name) {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["c"])(this);
            this.element = document.getElementById(name);
            // setting this after activate is a bug fix for presentation layer that does not happen with two...
            this.element.innerHTML = name;
        }
        _createClass(Three, [ {
            key: "input",
            value: function input(key, value) {
                // Sad workaround
                if (key === "transform") return __WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["b"].input(value);
                return value;
            }
        }, {
            key: "output",
            value: function output(key, value) {
                // Sad workaround
                if (key === "transform") return __WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["b"].output(value);
            ...
            value: function animationForKey(key, value, previous) {
                if (key === "x") return {
                    property: "transform",
                    type: __WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["b"],
    ...
    var Four = function() {
        function Four(name) {
            ...
            this.transform = "translate3d(0px,0px,0px)";
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["c"])(this);
            this.registerAnimatableProperty("transform", __WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["b"]);
            // default is number
            this.element = document.getElementById(name);
            // setting this after activate is a bug fix for presentation layer that does not happen with two...
            this.element.innerHTML = name;
    ...
    var one = new One("one");
    var two = new Two("two");
    var three = new Three("three");
    var four = new Four("four");
    var five = new Five("five");
    var six = document.getElementById("six");
    six.innerHTML = "six";
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["d"])(six);
    document.addEventListener("keydown", function(e) {
        var keyCode = e.keyCode;
        if (keyCode > 47 && keyCode < 58) {
            var width = document.body.offsetWidth;
            var height = document.body.offsetHeight;
            var duration = keyCode - 48;
            var transaction = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["e"])();
