...
function(module, __webpack_exports__, __webpack_require__) {
    ...
    var View = function() {
        function View(element, value) {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["a"])(this);
        ...
        _createClass(View, [ {
            ...
            value: function animationForKey(key, value, previous) {
                if (key === "positionArray") return {
                    type: new __WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["b"](__WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["c"], this.vertices * 2),
                    duration: duration,
                    easing: easing
                };
            }
    ...
    function resize() {
        canvas.width = window.innerWidth;
        canvas.height = window.innerHeight;
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__hyperact_mjs__["d"])(true);
        view.layout(rococo);
